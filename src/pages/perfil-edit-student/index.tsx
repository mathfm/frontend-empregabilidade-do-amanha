    ...
    <section className="w-full min-h-screen bg-purple-950 flex flex-col items-center justify-center p-4 md:p-8">
      <form className="flex flex-col gap-5 w-full max-w-md" onSubmit={handleSubmit(updateUser)}>
        ...
        <div className="flex flex-col md:flex-row justify-center gap-4">
          <button className="btn w-full md:w-auto bg-yellow-500 border-yellow-600 font-bold text-lg text-black hover:text-black hover:bg-white" onClick={() => _navigate("/perfil-estudante")}>Voltar</button>
          <button type="submit" className="btn w-full md:w-auto bg-yellow-500 border-yellow-600 font-bold text-lg text-black hover:text-black hover:bg-white">Atualizar</button>
        </div>
