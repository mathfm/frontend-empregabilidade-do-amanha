        ...
        {isCollaborator && (
          <>
            <div className="card-actions justify-center gap-8">
              <button className="btn w-28 bg-red-500 text-white border-red-900 hover:bg-red-900 hover:border-red-900" onClick={deleteCard}>Deletar</button>
              <button className="btn w-28 bg-yellow-400 border-yellow-800 text-black hover:border-yellow-800 hover:bg-yellow-800 hover:text-white" onClick={editCard}>Editar</button>
            </div>
          </>
        )}
      </div>
