...
export default function Login({ typeLogin }: LoginProp) {
    ...
    <ContainerImg>
      <section className={styles["login-container"]}>
        <div className={styles["link-login-container"]}>
          <p>
            Fazer login como{" "}
            <Link to={"/login-student"} className={styles["link-login"]}>
              Estudante
            </Link>{" "}
            ou{" "}
            <Link to={"/login-collaborator"} className={styles["link-login"]}>
              Colaborador
            </Link>
          </p>
        </div>
